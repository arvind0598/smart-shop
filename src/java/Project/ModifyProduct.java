...
public class ModifyProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String temp_cat_id = request.getParameter("cat_id") == null ? "-1" : request.getParameter("cat_id").toString();
        String temp_item_id = request.getParameter("cat_id") == null ? "-1" : request.getParameter("cat_id").toString();
        ...
        Boolean desc_ok = Helper.regexChecker(Regex.MIN_SIX_ALPHA_SPACES, desc);
        ...
        System.out.println(stock_ok + " " + offer_ok + " " + cost_ok + " " + admin_ok + " " + product_name_ok + " " + desc_ok + " " + keywords_ok);
        ...
        if(!admin_ok) {
            ...
            if(cost <= offer) {
                ...
                if(cat_id_ok) {
                    ...
                    obj.put("message", "Item was succesfully added.");
                }
