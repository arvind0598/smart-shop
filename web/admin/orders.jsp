<%-- 
    Document   : orders.jsp
    Created on : 6 Nov, 2018, 2:17:43 AM
    Author     : de-arth
--%>
...
<%
    ...
    JSONObject orders = new Project.Process().getActiveOrders();
        ...
        <div class="container">
            ...
            <c:forEach var="order" items="${orders}">
                ...
                <section>
                    ...
                    <div class="row">
                        <div class="col l6">
                            <p> Customer ID: ${order.value.cust_id} </p>
                            <p> Bill Amount: ${order.value.bill} </p>
                        </div>
                        <form class="col l6">
